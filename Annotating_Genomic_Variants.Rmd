...
* [Set Up](#setup) 
* [TRPV Variants](#TRPV) 
    * [Explore the VCF file header data](#TRPV_header)
    ...
    * [Predict the severity of the coding changes to protein structure and function](#TRPV_damage)
...
<h3 id="TRPV_explore">Explore the VCF file header data</h3>
...
Extract file header information with scanVcfHeader() and explore with the 
info() and geno() accessors.
...
<h3 id="TRPV_damage">Predict the severity of the coding changes to protein
...
<h2 id="vep">Annotating with the ensemblVEP pakage</h2>
